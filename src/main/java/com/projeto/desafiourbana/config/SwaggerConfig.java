...
public class SwaggerConfig {
	...
	private final ResponseMessage m409 = customMessage2();
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.POST, Arrays.asList(m201, m403, m409, m422, m500))
				.globalResponseMessage(RequestMethod.PUT, Arrays.asList(m204put, m403, m404, m409, m422, m500))
				.globalResponseMessage(RequestMethod.DELETE, Arrays.asList(m204del, m403, m404, m500))
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.projeto.usabilitybox.resources"))
	...
	private ResponseMessage customMessage2() {
		Map<String, Header> map = new HashMap<>();
		map.put("location", new Header("location", "URI do recurso existente", new ModelRef("string")));
		return new ResponseMessageBuilder()
				.code(409)
				.message("Conflito")
				.headersWithDescription(map)
